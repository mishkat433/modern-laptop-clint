    ...
    return (
        <div className='w-11/12 mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-20'>
                {
                    brandWiseLoad.map(singleProduct => <BrandCategoryCard setClose={setClose} singleProduct={singleProduct} key={singleProduct._id} setSelectProduct={setSelectProduct} />)
                }
            </div>
            <div>
